  ...
  return (
    <header id="header" className="text-white">
      ...
      >
        ...
        <nav>
          <ul className="flex [&>li>a]:inline-block [&>li>a]:px-3 [&>li>a]:py-1 [&>li>a]:text-sm [&>li>a]:font-medium">
            <HeaderMidLi section={'vehicles'} text={'Vehicles'} />
            <HeaderMidLi section={'energy'} text={'Energy'} />
            <HeaderMidLi section={'charging'} text={'Charging'} />
            <HeaderMidLi section={'discover'} text={'Discover'} />
            <HeaderMidLi section={'shop'} text={'Shop'} />
          </ul>
        </nav>
        <nav className="flex flex-1 justify-end">
          <ul className="flex [&>li>a]:inline-block [&>li>a]:h-4 [&>li>a]:w-6 [&>li]:px-2 [&>li]:py-2">
            ...
            <li>
              <a href="#">
                <svg
                  className="tds-icon tds-icon-person"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <path
